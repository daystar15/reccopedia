...
public class RestTemplateService {
    ...
    public String callSearchMovieAPI(String title) throws JsonProcessingException {
        ...
        try {
            ...
            UriComponents uri = UriComponentsBuilder.fromHttpUrl(searchUrl + "api_key=af1b14dca35a2db111be58155d08e240" + "language=ko").build();
    ...
    public String callContentAPI(int id) throws JsonProcessingException {
        ...
        try {
            ...
            UriComponents uri = UriComponentsBuilder.fromHttpUrl(contentUrl + "movie/" + id + "?" + "api_key=af1b14dca35a2db111be58155d08e240" + "&watch_region=KR&language=ko").build();
    ...
    public String callCrewAPI(int id) throws JsonProcessingException {
        ...
        try {
            ...
            UriComponents uri = UriComponentsBuilder.fromHttpUrl(contentUrl + "movie/" + id + "/credits" + "?" + "api_key=af1b14dca35a2db111be58155d08e240" + "&language=ko").build();
    ...
    public String callVideoAPI(int id) throws JsonProcessingException {
        ...
        try {
            ...
            UriComponents uri = UriComponentsBuilder.fromHttpUrl(contentUrl + "movie/" + id + "/videos" + "?" + "api_key=af1b14dca35a2db111be58155d08e240" + "&language=ko").build();
    ...
    public String callImagesAPI(int id) throws JsonProcessingException {
        ...
        try {
            ...
            UriComponents uri = UriComponentsBuilder.fromHttpUrl(contentUrl + "movie/" + id + "/images" + "?" + "api_key=af1b14dca35a2db111be58155d08e240" + "&language=ko").build();
    ...
    public String callFindAPI(String title) throws JsonProcessingException {
        ...
        try {
            ...
            UriComponents uri = UriComponentsBuilder.fromHttpUrl(multiUrl + title + "&language=ko").build();
