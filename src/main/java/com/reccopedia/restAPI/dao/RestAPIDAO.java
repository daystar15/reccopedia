...
@Controller // 컨트롤러 없으면 일단 GetMapping 걸어놓은 것 안보임
//@Service
public class RestAPIDAO { // dao에 가까움
	...
	@GetMapping("/polular") // 임시로 확인하기 위한 것
	...
	@GetMapping("/netfilx") // 임시로 확인하기 위한 것
	public String netfilxAPI() throws JsonProcessingException {
	...
	@GetMapping("/toprated") // 임시로 확인하기 위한 것
	public String topRatedAPI() throws JsonProcessingException {
