...
<div class="contets_wrap" data-api-id="${contents.id}" data-type-id="2">
	...
	<div class="contets_top">
		<div class="contents_short_box">
			...
			<div class="contents_info"  data-api-id="${contents.id}">
				<h2 class="title" data-api-title="${contents.original_name}">${contents.original_name}</h2>
				<h3>${contents.first_air_date} ~ ${contents.last_air_date} &#183; ${genre} &#183; ${countryResult}</h3>
			...
			<div class="contents_left">
				...
				<div class="basic_info contents_comm">
					<div class="basic_info_top">
						...
						<a href="/contents/tv_overview_view?id=${contents.id}">더보기</a>
					</div>
					<div class="basic_info_bottom">
						<p>${contents.name}</p>
						<p>${contents.status} &#183; ${countryResult} &#183; ${genre}</p>
						...
						<c:forEach var="similar" items="${similars}">
							<li>
								<a href="/contents/contents_view?id=${similar.id}">
									...
									<h3 class="content_subject">${similar.name}</h3>
									<div class="point">평균 &starf; <fmt:formatNumber value="${similar.vote_average/2}" pattern=".0"/></div>
								</a>
							</li>
						</c:forEach>
						</ul>
